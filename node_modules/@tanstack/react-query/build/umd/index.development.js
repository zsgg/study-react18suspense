...
(function (global, factory) {
  ...
  function useBaseQuery(options, Observer) {
    ...
    shim.useSyncExternalStore(React__namespace.useCallback(onStoreChange => {
      debugger;
      return isRestoring ? () => undefined : observer.subscribe(notifyManager.batchCalls(onStoreChange));
